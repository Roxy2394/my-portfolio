                    ...
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner js-fullheight">
                        <div className="desc">
                          ...
                          <p><a className="btn btn-primary btn-learn" href="https://drive.google.com/file/d/1twqst5QRTvwwbUUNORZicvrNeKG8pZ7K/view?usp=sharing" target="_blank" rel="noopener noreferrer">View resume<i className="icon-arrow-up-right2" /></a></p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          <h1>And I solve 1000pc jigsaw puzzles..</h1>
